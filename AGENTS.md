...
## Working Defaults
- Treat this directory as a paper library and paper-reading workspace.
- For requests to read, summarize, compare, inspect, or question a paper, use [$paper-reader](/Users/flame/Papers/.agents/skills/paper-reader/SKILL.md).
- Default deliverable is the chat response. Do not create notes, summaries, or index files unless the user explicitly asks for them.
